...
if ( ! function_exists( 'wpc_woocommerce_version_check' ) ) {
	function wpc_woocommerce_version_check( $version = '3.0' ) {
		global $woocommerce;
...
if ( ! function_exists( 'wpc_sanitize_block' ) ) {
	function wpc_sanitize_block( $var ) {
